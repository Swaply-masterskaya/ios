...
Ссылка на макет в Figma - [Swaply](https://www.figma.com/design/aSqwwFcjh3QxJU4jpQb2CV/Swaply-3.0?node-id=113-320)

# Стек

- SnapKit, Moya, Alamofire, SwiftLint, KingFisher, RxSwift;
- Swift Package Manager (SPM);
- Архитектура приложения: MVVM + Coordinator;
...
feature/фамилия/SW-1-что-сделал-кратко

**Пример создания ветки фикса бага:** <br>
bugfix/фамилия/SW-1-что-сделал-кратко

> [!NOTE]
> Номер (SW-*номер*) привязывается к номеру issue.

## Коммиты пишутся на русском языке.

**Пример:** <br>
[SW-1] - Поправил баг/ Добавил фичу, которая делает что-то
